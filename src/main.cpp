...
double get_next_car_s(double vx, double vy, double s, int prev_size) {
	double speed = sqrt(vx*vx + vy*vy);
  	
  	return s + (double)prev_size*0.02*speed;
}
          ...
          // j[1] is the data JSON object
          	...
          	if (prev_size > 0)
            {
          	...
          	for (int i=0; i<sensor_fusion.size(); i++) {
                ...
                double other_car_s = get_next_car_s(vx, vy, s, prev_size);
            	...
            	ref_vel += speed_diff;
              	if (ref_vel > MAX_SPEED) {
                	...
                	ref_vel = MAX_SPEED;
              		...
              		// velocity is less than min speed (MAX_ACC * 1s)
                	ref_vel = MAX_ACC;
              	}
